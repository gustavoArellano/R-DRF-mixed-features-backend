...
urlpatterns = [
    ...
    path('hosting-event-list/<str:pk>/', views.hostingList, name = "hosting-event-list"),
    ...
    path('join/<str:pk>/<str:id>/', views.joinEvent, name = "join-event"),
    path('leave/<str:pk>/<str:id>/', views.leaveEvent, name = "leave-event"),
